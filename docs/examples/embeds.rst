...
More information can be found in the :doc:`Embed Documentation </novacord/embed>`.

.. literalinclude:: ../../examples/embed_templates.py
   :language: python

1. Pass a string to the :meth:`~novacord.emb.error` method to send an error message.
