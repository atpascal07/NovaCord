...
3. Pass the language string into :meth:`~novacord.bot.Bot` to set your language.

.. code-block:: python

   bot = novacord.Bot(language="fr")  # French (loaded from ez_fr.json)
...
.. code-block:: python
   ...
   bot = novacord.Bot(language="auto", default_language="en")
...
.. literalinclude:: ../../novacord/internal/language/en.json
   :language: python
   :caption: The default language file for English.

.. literalinclude:: ../../novacord/internal/language/de.json
   :language: python
