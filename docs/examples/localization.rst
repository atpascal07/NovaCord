Localization
=======================
You can localize commands and strings with NovaCord.
More information can be found in the :doc:`Localization Documentation </novacord/i18n>`.
...
:meth:`~novacord.bot.Bot.localize_commands`.
...
Localize Strings
----------------
Strings can be localized by calling :class:`~novacord.i18n.I18N` like in the example above.
